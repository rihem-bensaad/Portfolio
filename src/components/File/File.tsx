            ...
            <div>
                ...
                <div className="clearfix"></div> 
                    <div className="col">
                        <div className="col thP">
                            <h3 className='titleP'>Darkitchen</h3>
                            <h5>Team Project • Developer • Tasks: Create HTTP Methods for RESTful Services, Details page, 
                            • Technologies: Agile methodology, Service Oriented Architecture. Angular, TypeScript, Semantic ui, Bootstrap, Node.js, Express.js, Git Workflow</h5>
                       </div>
                    </div>
                <div className="clearfix"></div> 
                ...
                <div className="col ">
                    <div className="outset">
                        ...
                        <h5>From June 2021 to July 2021 Thundr Tunis</h5>
                        <h5>Internship</h5>
